...
const url1 = "https://api.openweathermap.org/data/2.5/weather?lat=20.438&lon=-86.927&units=imperial&appid=eaa7d958886dda1b5fd5aa3be2aa0756";
const url2 = "https://api.openweathermap.org/data/2.5/forecast?lat=20.438&lon=-86.927&units=imperial&appid=eaa7d958886dda1b5fd5aa3be2aa0756";
...
function displayForecast(data) {
    ...
    data.list.forEach((element) => {
        ...
        if(today.getDate() != date.getDate() && counter < 1 && date.getUTCHours() == 15) {
            counter++;
            nextDay = element;
        }
    })
